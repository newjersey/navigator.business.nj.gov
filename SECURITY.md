...
You can view the latest releases on
[our GitHub releases page](https://github.com/newjersey/navigator.business.nj.gov/releases). We
support only the latest versions from that page.

| Version            | Supported          |
| ------------------ | ------------------ |
| 2026.x             | :white_check_mark: |
| 2025.x and earlier | :x:                |
...
reach out to any individual contributors or maintainers of this repository.
