...
const LegalStructureRadio = forwardRef(
  (props: Props, ref: ForwardedRef<HTMLDivElement>): ReactElement => {
    ...
    const legalStructureRadioLabels = (legalStructures: LegalStructure[]): ReactElement[] => {
      return legalStructures.map((legalStructure) => {
        return (
          ...
          <Accordion defaultExpanded={true}>
            ...
            <AccordionDetails>
              <FormControl variant="outlined" fullWidth>
                ...
                >
                  {legalStructureRadioLabels(commonLegalStructuresOrdered)}
                </RadioGroup>
              </FormControl>
            </AccordionDetails>
          </Accordion>
              ...
              <AccordionDetails>
                <FormControl variant="outlined" fullWidth>
                  <RadioGroup
                    ...
                    onChange={handleLegalStructure}
                  >
                    {legalStructureRadioLabels(otherLegalStructuresOrdered)}
                  </RadioGroup>
                </FormControl>
              </AccordionDetails>
            </Accordion>
