      ...
      <FormGroup>
        <FormControl variant="outlined" fullWidth>
          <FormControlLabel
            label={
              <Content>
                {Config.cannabisApplyForLicense.diverselyOwnedLabel}
              </Content>
            }
            control={
              <Checkbox
                ...
                onChange={(event): void =>
                  handleCheckbox(event, "diverselyOwned")
                }
          ...
          <FormControlLabel
            label={
              <Content>
                {Config.cannabisApplyForLicense.impactZoneLabel}
              </Content>
            }
            control={
              <Checkbox
          ...
          <FormControlLabel
            ...
            control={
              <Checkbox
                onChange={(event): void =>
                  handleCheckbox(event, "socialEquity")
                }
