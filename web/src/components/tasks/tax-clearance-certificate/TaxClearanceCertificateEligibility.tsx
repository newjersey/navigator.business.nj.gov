    ...
    <>
      <div data-testid="tax-clearance-certificate-tab-header">
        ...
        <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
          <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
            className="text-bold">{Config.taxClearanceCertificateTask.taxCertificateAgencyLabel}</span>
          </div>
      ...
      <div>
        <div className={"margin-bottom-1"}>
          <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
            <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
              className="text-bold">{Config.taxClearanceCertificateTask.businessNameLabel}</span>
            </div>
            <div className={"text-wrap"}>
              {isFormed && (
                <ArrowTooltip title={Config.profileDefaults.default.lockedFieldTooltipText}>
          ...
          <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
            <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
              className="text-bold">{Config.taxClearanceCertificateTask.entityIdLabel}</span>
            </div>
            <div className={"text-wrap"}>
              {isFormed && (
                <ArrowTooltip title={Config.profileDefaults.default.lockedFieldTooltipText}>
          ...
          {!isFormed ?? (<>
            <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
              <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
                className="text-bold">{Config.taxClearanceCertificateTask.addressLine1Label}</span>
              </div>
            </div>
            <div>
              <div className={"text-wrap"}>
            ...
            <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
              <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
                className="text-bold">{Config.taxClearanceCertificateTask.addressLine2Label}</span>
              </div>
            </div>
            <div className={"margin-bottom-1"}>
              <div className={"text-wrap"}>
          ...
          <div>
            {isFormed ? (<div className={"margin-bottom-1"}>
              <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
                <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
                  className="text-bold">{Config.taxClearanceCertificateTask.reviewSectionAddressLabel}</span>
                </div>
                <div className={"text-wrap"}>
                  <ArrowTooltip title={Config.profileDefaults.default.lockedFieldTooltipText}>
                    <div className="fdr fac  font-body-lg">
              ...
              <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2 margin-bottom-1"}`}>
                <div className={"text-wrap"}>
                  <div>Checking</div>
                </div>
              </div>
        ...
        <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
          <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
            className="text-bold">{Config.taxClearanceCertificateTask.taxIdLabel}</span>
          </div>
          <div className={"text-wrap"}>
            {isFormed && (
              <ArrowTooltip title={Config.profileDefaults.default.lockedFieldTooltipText}>
        ...
        <div className={`flex ${isTabletAndUp ? "flex-row" : "flex-column margin-right-2"}`}>
          <div className={`${isTabletAndUp ? "padding-right-1" : ""}`}><span
            className="text-bold">{Config.taxClearanceCertificateTask.taxPinLabel}</span>
          </div>
          <div className={"text-wrap"}>
            {isFormed && (
              <ArrowTooltip title={Config.profileDefaults.default.lockedFieldTooltipText}>
