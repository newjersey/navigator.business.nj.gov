...
jest.mock("@/lib/api-client/apiClient", () => ({ postTaxClearanceDocument: jest.fn() }));
...
describe("<AnyTimeActionTaxClearanceCertificateReviewElement />", () => {
  ...
  it("makes the api post request", () => {
    // const business = generateBusiness({ user: generateUser({ id: "456" }) });
