...
export const TaxClearanceStepThree = (props: Props): ReactElement => {
  ...
  const isAddressComplete = Boolean(
    business?.taxClearanceCertificateData?.addressLine1?.trim() &&
      business?.taxClearanceCertificateData?.addressLine2?.trim() &&
      business?.taxClearanceCertificateData?.addressCity?.trim() &&
      business?.taxClearanceCertificateData?.addressState &&
      business?.taxClearanceCertificateData?.addressZipCode?.trim()
  );
