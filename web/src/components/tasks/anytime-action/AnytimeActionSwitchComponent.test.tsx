...
describe("AnytimeActionSwitchComponent", () => {
  const initialFeatureTaxClearanceCertificateEnv =
    process.env.FEATURE_TAX_CLEARANCE_CERTIFICATE;

  afterEach(() => {
    process.env.FEATURE_TAX_CLEARANCE_CERTIFICATE =
      initialFeatureTaxClearanceCertificateEnv;
  });
  ...
  describe("FEATURE_TAX_CLEARANCE_CERTIFICATE feature flag", () => {
    it("renders tax clearance certificate element", () => {
      ...
      const task = generateAnytimeActionTask({
