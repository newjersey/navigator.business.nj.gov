...
import { Business, generateWasteQuestionnaireData } from "@businessnjgovnavigator/shared/index";
...
describe("<CheckWastePermitsResults />", () => {
  ...
  it("displays the texts of the responses that are true in user data", () => {
    ...
    expect(
      screen.getByText(Config.envReqQuestionsPage.waste.questionnaireOptions.hazardousMedicalWaste)
    ).toBeInTheDocument();
    expect(
      screen.getByText(Config.envReqQuestionsPage.waste.questionnaireOptions.compostWaste)
    ).toBeInTheDocument();
  });
  ...
  it("doesn't display the texts of the responses that are false in user data", () => {
    ...
    expect(
      screen.queryByText(Config.envReqQuestionsPage.waste.questionnaireOptions.constructionDebris)
    ).not.toBeInTheDocument();
    expect(
      screen.queryByText(Config.envReqQuestionsPage.waste.questionnaireOptions.treatProcessWaste)
    ).not.toBeInTheDocument();
  });
