    ...
    describe("Business Designator", () => {
      describe("Business Designator secondary label foreign corporation", () => {
        it.each(corpLegalStructures)(
          "Shows secondary label foreign corporation",
        ...
        it.each(nonCorporationLegalStructures)(
          "Does Not shows secondary label foreign corporation when legal structure is not a corporation for Dakotas",
          async (legalStructureId) => {
            await getPageHelper({ businessPersona: "FOREIGN", legalStructureId }, {});
            expect(
              screen.queryByText(Config.formation.fields.businessSuffix.labelSecondaryTextForeignCorporation)
            ).not.toBeInTheDocument();
          }
        );

        it.each(incorporationLegalStructures)(
          "Does Not shows secondary label foreign corporation for Oscars",
          async (legalStructureId) => {
            await getPageHelper({ businessPersona: "OWNING", legalStructureId }, {});
            expect(
              screen.queryByText(Config.formation.fields.businessSuffix.labelSecondaryTextForeignCorporation)
        ...
        it.each(incorporationLegalStructures)(
          "Does Not shows secondary label foreign corporation for Poppy",
          async (legalStructureId) => {
            await getPageHelper({ businessPersona: "STARTING", legalStructureId }, {});
            expect(
              screen.queryByText(Config.formation.fields.businessSuffix.labelSecondaryTextForeignCorporation)
            ).not.toBeInTheDocument();
          }
