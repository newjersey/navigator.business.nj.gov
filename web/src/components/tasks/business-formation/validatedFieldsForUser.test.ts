...
describe("validatedFieldsForUser", () => {
  ...
  describe("registeredAgent", () => {
    it("requires registered agent fields for MYSELF for all legal structures", () => {
    ...
    it("requires registered agent fields for AUTHORIZED_REP for all legal structures", () => {
      const legalStructureId = randomFormationLegalType();
      const formationFormData = generateFormationFormData(
    ...
    it("requires registered agent fields for PROFESSIONAL_SERVICE for all legal structures", () => {
      const legalStructureId = randomFormationLegalType();
      const formationFormData = generateFormationFormData(
