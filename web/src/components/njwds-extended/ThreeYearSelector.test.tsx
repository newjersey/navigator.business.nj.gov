...
describe("<ThreeYearSelector />", () => {
  ...
  it("displays the left and right chevron when at the center of the year array", () => {
    ...
    expect(screen.getByTestId("year-selector-left")).not.toHaveClass(
      "visibility-hidden"
    );
    expect(screen.getByTestId("year-selector-left")).toBeEnabled();
    expect(screen.getByTestId("year-selector-right")).not.toHaveClass(
      "visibility-hidden"
    );
  ...
  it("hides the left chevron when at the beginning of the year array", () => {
    ...
    expect(screen.getByTestId("year-selector-left")).toHaveClass(
      "visibility-hidden"
    );
  ...
  it("hides the right chevron when at the end of the year array", () => {
    ...
    expect(screen.getByTestId("year-selector-right")).toHaveClass(
      "visibility-hidden"
    );
