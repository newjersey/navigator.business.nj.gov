...
describe("<ChecklistTag />", () => {
  it("renders the Completed tag with the correct text and icon", () => {
    ...
    expect(
      screen.getByText(Config.licenseSearchTask.completedStatusText)
    ).toBeInTheDocument();
  ...
  it("renders the Pending tag with the correct text and icon", () => {
    ...
    expect(
      screen.getByText(Config.licenseSearchTask.pendingPermitStatusText)
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("schedule-checklist-tag-icon")
    ).toBeInTheDocument();
  });
  ...
  it("renders the Scheduled tag with the correct text and icon", () => {
    ...
    expect(
      screen.getByText(Config.licenseSearchTask.scheduledStatusText)
    ).toBeInTheDocument();
  ...
  it("renders the Incomplete tag with the correct text and icon", () => {
    ...
    expect(
      screen.getByText(Config.licenseSearchTask.incompleteStatusText)
    ).toBeInTheDocument();
  ...
  it("renders the Not Applicable tag with the correct text and icon", () => {
    ...
    expect(
      screen.getByText(Config.licenseSearchTask.notApplicableStatusText)
    ).toBeInTheDocument();
    expect(
      screen.getByTestId("do-not-disturb-checklist-tag-icon")
    ).toBeInTheDocument();
  });
});
