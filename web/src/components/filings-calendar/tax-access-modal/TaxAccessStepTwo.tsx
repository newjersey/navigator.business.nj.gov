...
import { DataFormErrorMapContext, DataFormFields } from "@/contexts/dataFormErrorMapContext";
...
export const TaxAccessStepTwo = (props: Props): ReactElement => {
  ...
  const fields: DataFormFields[] = ["businessName", "taxId", "responsibleOwnerName"];
  ...
  const errorMessages: Partial<Record<DataFormFields, string>> = {
