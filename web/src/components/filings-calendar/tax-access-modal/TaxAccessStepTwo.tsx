...
import { DataFieldFormContext, DataFields } from "@/contexts/dataFieldFormContext";
...
export const TaxAccessStepTwo = (props: Props): ReactElement => {
  ...
  const fields: DataFields[] = ["businessName", "taxId", "responsibleOwnerName"];
  ...
  const errorMessages: Partial<Record<DataFields, string>> = {
