  ...
  return (
    <>
      {rswitch(props.card.id, {
        [SIDEBAR_CARDS.fundingNudge]: (
          <SidebarCardFundingNudge card={props.card} />
        ),
        [SIDEBAR_CARDS.formationNudge]: (
          <SidebarCardFormationNudge card={props.card} />
        ),
        [SIDEBAR_CARDS.goToProfile]: (
          <SidebarCardGoToProfileNudge card={props.card} />
        ),
