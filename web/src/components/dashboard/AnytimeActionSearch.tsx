              ...
              <li
                ...
                onClick={() => {
                  if (router && option) {
                    ...
                    if (option.type === "task") {
                      router.push(
                        `${ROUTES.anytimeActions}/${(option as AnytimeActionTask).urlSlug}`,
                      );
                    }
                    if (option.type === "license-reinstatement") {
                      router.push(
                        `${ROUTES.licenseReinstatement}/${(option as AnytimeActionLicenseReinstatement).urlSlug}`,
                      );
                    }
                  }
                }}
