      ...
      >
        ...
        {props.opportunity.dueDate && (
          <div className="dashboard-opportunity-card-due-date">
            <span
              data-testid={`${props.opportunity.id}-dueDate-header`}
              className="dashboard-opportunity-card-due-date-header"
            >
              {Config.dashboardDefaults.fundingCertificationDueText}
            </span>
            {props.opportunity.dueDate}{" "}
          </div>
        )}
