...
describe("<RegistrationStatusSnackbar />", () => {
  ...
  it("shows registration success snackbar when user is authenticated and had completed the registration process", () => {
    ...
    expect(
      screen.getByText(
        markdownToText(Config.selfRegistration.accountSuccessSnackbarBody)
      )
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        markdownToText(Config.selfRegistration.accountSuccessSnackbarTitle)
      )
    ).toBeInTheDocument();
  ...
  it("shows duplicate registration error snackbar alert when user had failed the registration process", () => {
    ...
    expect(
      screen.getByText(
        markdownToText(Config.selfRegistration.errorTextDuplicateSignUp)
      )
    ).toBeInTheDocument();
    expect(
      screen.queryByText(
    ...
    expect(
      screen.queryByTestId("congratulations-logo")
    ).not.toBeInTheDocument();
  });
