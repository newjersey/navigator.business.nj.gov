...
export const NavBarDesktopWrapper = (
  props: NavBarDesktopWrapperProps
): ReactElement => {
  return (
    <div
      className={`${
        props.CMS_ONLY_disableSticky ? "" : "position-sticky"
      } top-0 z-500 bg-white`}
      id={NAVBAR_WRAPPER_DESKTOP_ID}
    >
      <OutageAlertBar />
      <nav
        aria-label="Primary"
        className="grid-container-widescreen desktop:padding-x-7"
      >
