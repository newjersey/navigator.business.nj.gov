...
const FormationDateModalContent = (props: Props): ReactElement => {
...
export const FormationDateModal = (props: Props): ReactElement => {
  ...
  const businessSnapshotKey = business
    ? `${business.id}:${business.version}:${business.lastUpdatedISO}`
    : "business-loading";

  return <FormationDateModalContent key={businessSnapshotKey} {...props} />;
};
