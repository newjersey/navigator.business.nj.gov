import {
  ...
  loadXrayRenewalCalendarEventUrlSlug,
...
describe("loadRenewalCalendarEvents", () => {
  ...
  describe("loadXrayRenewalCalendarEventUrlSlug", () => {
    it("returns the xray calendar event urlSlug", () => {
      const xrayRenewal =
        "---\n" +
        'urlSlug: "xray-renewal"\n' +
        'callToActionLink: "callToAction.com"\n' +
      ...
      expect(loadXrayRenewalCalendarEventUrlSlug()).toEqual({
        params: {
          xrayRenewalCalendarEventUrlSlug: "xray-renewal",
        },
      });
    });
  });
