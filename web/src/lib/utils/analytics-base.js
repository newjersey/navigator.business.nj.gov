...
const userUpdate = (user_update) => {
  ...
  // console.log("in main function", user_update);
  // console.log("typeof", typeof user_update);
  // console.log(
  //   "typeof user_update[Symbol.iterator] === function",
  //   typeof user_update[Symbol.iterator] === "function",
  // );
  ...
  //   }
  // }
  // 2 updateKey exists in data key -> compare values -> if not undefined and not the same -> send
