export default {
  ...
  fields: [
    ...
    },
    {
      ...
      default: "",
      widget: "string",
      hint: "quickReference can display this icon",
    },
    {
    ...
    },
    {
      ...
      default: "",
      widget: "string",
      hint: "quickReference can display this icon; a phone link will render",
    },
    {
      name: "emailIconText",
      ...
      default: "",
      widget: "string",
      hint: "quickReference can display this icon; an email link will render",
    },
  ],
