...
describe("hasEssentialQuestion", () => {
  ...
  describe("getEssentialQuestion", () => {
    it("returns multiple essential questions when industry with multiple essential is selected", () => {
      const fieldNames = getEssentialQuestion("multipleEqId").map(
        (eQ) => eQ.fieldName
      );
  ...
  describe("hasEssentialQuestion", () => {
    describe("isCarServiceApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("carService")(undefined)
        ).toEqual(false);
      });

      it("returns false when industry does not have a car service option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("carService")(
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("carService")("fake-industry")
        ).toEqual(false);
      });
    ...
    describe("isCannabisLicenseApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("cannabisLicenseType")(undefined)
        ).toEqual(false);
      });
    ...
    describe("isLiquorLicenseApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("liquorLicense")(undefined)
        ).toEqual(false);
      });

      it("returns false when industry does not have a liquor license option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("liquorLicense")(
            "fake-industry-with-no-eq"
          )
        ).toEqual(false);
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("liquorLicense")("fake-industry")
        ).toEqual(false);
      });
    ...
    describe("isInterstateMovingApplicable", () => {
      it("returns false when there is no industry", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateMoving")(undefined)
        ).toEqual(false);
      });

      it("returns false when industry does not fall under moving company", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateMoving")(
            "fake-industry-with-no-eq"
          )
        ).toEqual(false);
      });
    ...
    describe("isInterstateLogisticsApplicable", () => {
      it("returns false when there is no industry", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateLogistics")(undefined)
        ).toEqual(false);
      });

      it("returns false when industry does not fall under logistics company", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateLogistics")(
            "fake-industry-with-no-eq"
          )
        ).toEqual(false);
      });
    ...
    describe("isCpaRequiredApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("requiresCpa")(undefined)
        ).toEqual(false);
      });

      it("returns false when industry does not have a CPA option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("requiresCpa")(
            "fake-industry-with-no-eq"
          )
        ).toEqual(false);
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("requiresCpa")("fake-industry")
        ).toEqual(false);
      });
    ...
    describe("willSellPetCareItems", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("willSellPetCareItems")(
            undefined
          )
        ).toEqual(false);
      });
    ...
    describe("isPetCareApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("petCareHousing")(undefined)
        ).toEqual(false);
      });

      it("returns false when industry does not have a petCareHousing option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("petCareHousing")(
            "fake-industry-with-no-eq"
          )
        ).toEqual(false);
      });
