  ...
  describe("hasEssentialQuestion", () => {
    describe("isCarServiceApplicable", () => {
      ...
      it("returns false when industry does not have a car service option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("carService")("fake-industry-with-no-eq"),
        ).toEqual(false);
      });
      ...
      it("returns true when industry has a car service option", () => {
        expect(getIsApplicableToFunctionByFieldName("carService")("fake-industry-with-eq")).toEqual(
          true,
        );
      });
    });
    ...
    describe("isCannabisLicenseApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(getIsApplicableToFunctionByFieldName("cannabisLicenseType")(undefined)).toEqual(
          false,
        );
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("cannabisLicenseType")("fake-industry"),
        ).toEqual(false);
      });

      it("returns true when industry is cannabis", () => {
        expect(
          getIsApplicableToFunctionByFieldName("cannabisLicenseType")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("isCertifiedInteriorDesignerApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("certifiedInteriorDesigner")(undefined),
        ).toEqual(false);
      });

      it("returns false when industry does not have a certified interior designer option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("certifiedInteriorDesigner")(
            "fake-industry-with-no-eq",
          ),
        ).toEqual(false);
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("certifiedInteriorDesigner")("fake-industry"),
        ).toEqual(false);
      });
    ...
    describe("isRealEstateAppraisalManagementApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("realEstateAppraisalManagement")(undefined),
        ).toEqual(false);
      });
    ...
    describe("isProvidesStaffingServicesApplicable", () => {
      it("returns false when no industry is supplied", () => {
        expect(getIsApplicableToFunctionByFieldName("providesStaffingService")(undefined)).toEqual(
          false,
        );
      });
      ...
      it("returns false when industry does not have a staffing service option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("providesStaffingService")(
            "fake-industry-with-no-eq",
          ),
        ).toEqual(false);
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("providesStaffingService")("fake-industry"),
        ).toEqual(false);
      });
    ...
    describe("isLiquorLicenseApplicable", () => {
      ...
      it("returns false when industry does not have a liquor license option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("liquorLicense")("fake-industry-with-no-eq"),
        ).toEqual(false);
      });

      it("returns false when industry does not exist", () => {
        expect(getIsApplicableToFunctionByFieldName("liquorLicense")("fake-industry")).toEqual(
          false,
        );
      });
      ...
      it("returns true when industry has a liquor license option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("liquorLicense")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("isInterstateMovingApplicable", () => {
      ...
      it("returns false when industry does not fall under moving company", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateMoving")("fake-industry-with-no-eq"),
        ).toEqual(false);
      });

      it("returns false when industry does not exist", () => {
        expect(getIsApplicableToFunctionByFieldName("interstateMoving")("fake-industry")).toEqual(
          false,
        );
      });
      ...
      it("returns true when industry is a moving company", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateMoving")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("isInterstateLogisticsApplicable", () => {
      it("returns false when there is no industry", () => {
        expect(getIsApplicableToFunctionByFieldName("interstateLogistics")(undefined)).toEqual(
          false,
        );
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateLogistics")("fake-industry"),
        ).toEqual(false);
      });

      it("returns true when industry is a logistics company", () => {
        expect(
          getIsApplicableToFunctionByFieldName("interstateLogistics")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("isCpaRequiredApplicable", () => {
      ...
      it("returns false when industry does not have a CPA option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("requiresCpa")("fake-industry-with-no-eq"),
        ).toEqual(false);
      });
      ...
      it("returns true when industry has a CPA option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("requiresCpa")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("willSellPetCareItems", () => {
      it("returns false when no industry is supplied", () => {
        expect(getIsApplicableToFunctionByFieldName("willSellPetCareItems")(undefined)).toEqual(
          false,
        );
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("willSellPetCareItems")("fake-industry"),
        ).toEqual(false);
      });

      it("returns true when industry is the pet care industry", () => {
        expect(
          getIsApplicableToFunctionByFieldName("willSellPetCareItems")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("isChildcareForSixOrMoreApplicable", () => {
      it("returns false when there is no industry", () => {
        expect(getIsApplicableToFunctionByFieldName("isChildcareForSixOrMore")(undefined)).toEqual(
          false,
        );
      });
      ...
      it("returns false when industry does not exist", () => {
        expect(
          getIsApplicableToFunctionByFieldName("isChildcareForSixOrMore")("fake-industry"),
        ).toEqual(false);
      });

      it("returns false when industry does not provide childcare for six or more", () => {
        expect(
          getIsApplicableToFunctionByFieldName("isChildcareForSixOrMore")(
            "fake-industry-with-no-eq",
          ),
        ).toEqual(false);
      });
    ...
    describe("isPetCareApplicable", () => {
      ...
      it("returns false when industry does not have a petCareHousing option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("petCareHousing")("fake-industry-with-no-eq"),
        ).toEqual(false);
      });

      it("returns false when industry does not exist", () => {
        expect(getIsApplicableToFunctionByFieldName("petCareHousing")("fake-industry")).toEqual(
          false,
        );
      });
      ...
      it("returns true when industry has a pet care option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("petCareHousing")("fake-industry-with-eq"),
        ).toEqual(true);
      });
    });
    ...
    describe("Employment Agency", () => {
      it("returns false when no industry is supplied", () => {
        expect(
          getIsApplicableToFunctionByFieldName("employmentPersonnelServiceType")(undefined),
        ).toEqual(false);
        expect(getIsApplicableToFunctionByFieldName("employmentPlacementType")(undefined)).toEqual(
          false,
        );
      });
      ...
      it("returns false when industry does not exist", () => {
        ...
        expect(
          getIsApplicableToFunctionByFieldName("employmentPlacementType")("fake-industry"),
        ).toEqual(false);
      });

      it("returns false when industry does not have an employment agency option", () => {
        expect(
          getIsApplicableToFunctionByFieldName("employmentPersonnelServiceType")(
            "fake-industry-with-no-eq",
          ),
        ).toEqual(false);
        expect(
          getIsApplicableToFunctionByFieldName("employmentPlacementType")(
            "fake-industry-with-no-eq",
          ),
        ).toEqual(false);
      });
