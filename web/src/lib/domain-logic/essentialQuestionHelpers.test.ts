...
describe("hasEssentialQuestion", () => {
  ...
  describe("isCertifiedInteriorDesignerApplicable", () => {
    ...
    it("returns true when industry has a certified interior designer option", () => {
      expect(getIsApplicableToFunctionByFieldName("certifiedInteriorDesigner")("interior-designer")).toEqual(
        true
      );
    });
  });
  ...
  describe("isRealEstateAppraisalManagementApplicable", () => {
    it("returns false when no industry is supplied", () => {
      expect(getIsApplicableToFunctionByFieldName("realEstateAppraisalManagement")(undefined)).toEqual(false);
    });
    ...
    it("returns false when industry does not exist", () => {
      expect(getIsApplicableToFunctionByFieldName("realEstateAppraisalManagement")("fake-industry")).toEqual(
        false
      );
    });
  ...
  describe("isProvidesStaffingServicesApplicable", () => {
    ...
    it("returns false when industry does not exist", () => {
      expect(getIsApplicableToFunctionByFieldName("providesStaffingService")("fake-industry")).toEqual(false);
    });

    it("returns true when industry has a certified interior designer option", () => {
      expect(getIsApplicableToFunctionByFieldName("providesStaffingService")("it-consultant")).toEqual(true);
    });
  });
  ...
  describe("isChildcareForSixOrMoreApplicable", () => {
    ...
    it("returns false when industry does not exist", () => {
      expect(getIsApplicableToFunctionByFieldName("isChildcareForSixOrMore")("fake-industry")).toEqual(false);
    });

    it("returns false when industry is an architecture firm", () => {
      expect(getIsApplicableToFunctionByFieldName("isChildcareForSixOrMore")("architecture")).toEqual(false);
    });
