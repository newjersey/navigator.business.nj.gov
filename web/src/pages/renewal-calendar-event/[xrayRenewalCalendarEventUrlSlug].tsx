...
import {
  ...
  XrayRenewalCalendarEventUrlSlugParam,
...
export const getStaticPaths = (): GetStaticPathsResult<XrayRenewalCalendarEventUrlSlugParam> => {
  const path = loadXrayRenewalCalendarEventUrlSlug();
  return {
    paths: [path],
    fallback: false,
  };
