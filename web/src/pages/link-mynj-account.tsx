...
const LinkMyNJAccountPage = (): ReactElement => {
  ...
  useEffect(() => {
    (async (): Promise<void> => {
      if (
        ...
        state.activeUser?.encounteredMyNjLinkingError === false &&
        !state.activeUser.id.includes("@")
      ) {
...
export default LinkMyNJAccountPage;
