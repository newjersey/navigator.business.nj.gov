    ...
    for (const industry of industries) {
      it(`Onboarding for ${industry.name}`, () => {
        ...
        if (isChildcareForSixOrMore === undefined) {
          ...
          onOnboardingPageStartingBusiness.selectChildcareRadio(
            isChildcareForSixOrMore
          );
          onOnboardingPageStartingBusiness
        ...
        if (petCareHousing === undefined) {
          ...
          onOnboardingPageStartingBusiness.selectPetCareHousingRadio(
            petCareHousing
          );
          onOnboardingPageStartingBusiness
        ...
        if (willSellPetCareItems === undefined) {
          ...
          onOnboardingPageStartingBusiness.selectWillSellPetcareItemsRadio(
            willSellPetCareItems
          );
          onOnboardingPageStartingBusiness
        ...
        if (residentialConstructionTypeApplicable === undefined) {
          ...
          onOnboardingPageStartingBusiness.selectConstructionTypeRadio(
            constructionType
          );
          onOnboardingPageStartingBusiness
