...
module.exports = withBundleAnalyzer({
  env: {
    ...
    FEATURE_BUSINESS_LLP: process.env.FEATURE_BUSINESS_LLP,
    FEATURE_BUSINESS_CCORP: process.env.FEATURE_BUSINESS_CCORP,
    FEATURE_BUSINESS_SCORP: process.env.FEATURE_BUSINESS_SCORP,
