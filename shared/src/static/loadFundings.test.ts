import fs from "fs";
import { loadAllFundings, loadAllFundingUrlSlugs, loadFundingByUrlSlug } from "./loadFundings";
  ...
  describe("loadAllFundings", () => {
    it("returns a list of all fundings", () => {
      const fundingMd1 =
        ...
        "homeBased: yes\n" +
        "certifications: []\n" +
        "preferenceForOpportunityZone: undefined\n" +
        "county:\n" +
        "  - All\n" +
        "sector:\n" +
        "  - cannabis\n" +
      ...
      mockReadDirectoryReturn({ value: ["opp1.md", "opp2.md"], mockedFs });
