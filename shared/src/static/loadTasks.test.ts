...
describe("loadTasks", () => {
  ...
  describe("loadTaskByFileName", () => {
    it("loadTaskByFileName with both licenseTask and task dependencies", () => {
      ...
      mockReadDirectoryReturnOnce({ value: ["task1.md"], mockedFs });
      mockReadDirectoryReturnOnce({ value: ["license1.md", "license2.md"], mockedFs });
      mockReadDirectoryReturnOnce({ value: [], mockedFs });
  ...
  describe("loadAllTaskUrlSlugs", () => {
    it("returns a list of task url slugs from within task files", () => {
      ...
      mockReadDirectoryReturnOnce({ value: ["task1.md", "task2.md"], mockedFs });
      mockReadDirectoryReturnOnce({ value: ["license1.md"], mockedFs });
      mockReadDirectoryReturnOnce({ value: ["step1.md"], mockedFs });
      mockReadDirectoryReturnOnce({ value: [], mockedFs });
      mockReadDirectoryReturnOnce({ value: [], mockedFs });
  ...
  describe("loadTaskByUrlSlug", () => {
    it("returns task entity from url slug", () => {
      ...
      mockReadDirectoryReturnOnce({ value: ["task1.md", "task2.md", "task3.md"], mockedFs });
