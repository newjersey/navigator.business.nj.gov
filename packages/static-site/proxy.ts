...
/**
 * Authentication realm shown by browsers when a non-production environment asks
 * for static-site credentials.
 */
...
/**
 * Applies Basic Auth for deployed non-production environments before locale routing.
 */
