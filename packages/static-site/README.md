...
version. Non-production ECS deployments enable HTTP Basic Auth from the repository-level
`BASIC_AUTH_USERNAME` variable and `BASIC_AUTH_PASSWORD` secret. Production and local runs leave
Basic Auth disabled.
