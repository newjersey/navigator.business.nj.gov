...
2. **All automated checks must pass.** Biome formatting and linting, dependency checks, and any
   other CI checks must be green before you request a human review.
