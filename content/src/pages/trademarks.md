...
slug: "trademarks"
webflowId: "6168414ed3df6abba739c6cd"
category: "5e31b06cb76b83de0d358b83"
rank: 6
sub-heading-text: "Whether it’s your brand, original works, or an invention, there are legal provisions, like trademarks, available to help protect it from infringement or damage of reputation by another company."
teaser-text: "View legal provisions available to help protect"
include-in-home-slider: false
is-sub-page: false
main-link-text: "Learn More about Legal Protections"
coming-soon: false
is-unique-page: false
navigator-button: false
main-text-1: "While they are all ways of protecting your intellectual property, trademarks protect items that define a company brand (like a business name or a logo), copyrights protect literary and artistic materials (like a book or a song), and patents protect inventions (like a new tool). Please see below for details on the legal provisions most relevant to your business."
heading-2: "Register a Trademark"
main-text-2: |
  ...
  This is a separate process from the federal trademark registration process. You can register a brand or service with the state of New Jersey by submitting form [TMSM-01](https://www.state.nj.us/treasury/revenue/dcr/pdforms/tmsm01.pdf) to the NJ Division of Revenue. [Additional information on state trademark registration](https://www.state.nj.us/treasury/revenue/regmark.shtml)
  ...
  **Mail your form to:**
  ...
  1.  Before filing an application, you need to search through the pending and registered trademarks to make sure your brand doesn’t already exist. The U.S. Patent and Trademark Office has a database to [search through existing trademarks](https://www.uspto.gov/trademarks-application-process/search-trademark-database). When you’re ready, [apply for a federal trademark](https://www.uspto.gov/) online.
...
main-text-3: |
  ...
  Local: 571-272-1000
  TTY: 800-877-8339
heading-4: "Register for Copyrights"
main-text-4: |
  ...
  The United States Copyright Office is a division of the Library of Congress and is responsible for managing federal copyright protection. Information on copyrights and applications for filing for copyright protection may be obtained from the [United States Copyright Office](http://www.copyright.gov/).
