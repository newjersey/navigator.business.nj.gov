...
webflowId: "5e31b06cb76b832a59358bc3"
category: "5e31b06cb76b83de0d358b83"
rank: 4
sub-heading-text: "Hiring employees in New Jersey requires just a few steps. For instance, you'll need to verify their eligibility to work as well as register to pay employer and payroll taxes."
teaser-text: "Know what to do when you hire new employees"
include-in-home-slider: false
is-sub-page: false
main-link-text: "Hiring Employees"
...
main-text-4: |
  Be sure to register as an employer with the State of New Jersey Division of Revenue and Enterprise Services. Registering as an employer means that you will need to start paying State payroll taxes, including unemployment Insurance Tax State Disability Insurance, and other withholdings.
...
main-text-6: |
  Businesses can receive help recruiting talent and diversifying their applicant search from the New Jersey Department of Labor and Workforce Development's (NJDOL). Here are some of the services that may be available to your business.
  ...
  Hiring minors or young workers comes with incredible possibilities and specific support services and provisions. More information regarding [youth employment can be found on NJDOL's website](https://nj.gov/labor/youngworkers/)., including labor laws, opportunities for apprenticeships, and necessary paperwork for employment under 18.
...
main-text-7: |
  ...
  Per New Jersey Unemployment Compensation Law, commonly referred to as the ABC test, a worker should be considered an employee _unless all_ the following circumstances apply:

  1\. The individual has been and will continue to be free from control or direction over the performance of work performed, both under a contract of service and in fact; _and_

  2\. The work is either outside the usual course of the business for which such service is performed, or the work is performed outside of all the places of business of the enterprise for which such service is performed; _and_‍

  3\. The individual is customarily engaged in an independently established trade, occupation, profession, or business.

  ‍
heading-8: "Pay and Benefits Transparency Requirements for Job Postings and Promotions"
main-text-8: |
  [New Jersey pay and benefit transparency law](https://www.nj.gov/labor/myworkrights/wages/pay-transparency/) requires most employers to:

  *   List pay, benefits, and other compensation in all job postings they create or manage
  *   Make reasonable efforts to notify current employees in the affected departments when a promotion is available

  This law covers businesses that:

  *   Have 10 or more employees over 20 or more calendar weeks
  *   Do business, hire, or accept job applications in New Jersey

  This law applies to job listings on websites, in print advertisements, newsletters, emails, social media, and more.
heading-9: "Some Workplace Rules Can Hurt Certain Groups"
main-text-9: |
  Some workplace rules seem fair, but can make it harder for certain groups to get hired. Employers should make rules that are fair and treat all workers the same. Don't treat workers differently because of their race, gender, disability, religion, or other protected group. Only use a rule if it's really needed for the job.

  Some hiring practices that may be unfair include:

  *   **Criminal history checks:** Saying no to anyone with a criminal record can be unfair. Think about what the crime was, how long ago it happened, and if it relates to the job
  *   **Language or citizenship rules:** Don’t require English, certain citizenship, or a driver's license if the job doesn't really need them
  *   **AI and automated hiring tools:** Check computer programs that screen resumes. Make sure they don't screen out people from protected groups by accident
