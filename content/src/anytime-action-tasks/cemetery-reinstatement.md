...
---
1. Your affiliated cemetery must send a written request on letterhead by mail to the New Jersey Cemetery Board, asking for your license to be reinstated (and branch license, if applicable). They must include your name and current license number.
...
:::callout{ showHeader="true" headerText="What if I don't reinstate my license?" showIcon="false" calloutType="conditional" }

Your cemetery salesperson license will be suspended without a hearing and any associated branch license(s) will be inactive.

:::

:::callout{ showHeader="true" headerText="" showIcon="false" calloutType="conditional" }

The same cemetery salesperson license number, valid for 2 years.
