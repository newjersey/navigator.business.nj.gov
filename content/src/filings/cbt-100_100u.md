...
**Combined Return Filers**, the group (filing CBT-100/100u) must have a registered `managerial member|tax-managerial-member` to make payments or file returns. Once registered, the managerial member will be assigned a Unitary ID number that must be used to submit returns and payments.
