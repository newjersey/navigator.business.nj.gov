 ...
 * by fully expanding the `v196UserData` type from the migration source.
 *
...
/**
 * Uses the TypeScript Compiler API to resolve the `v196UserData` interface and
...
export const generateTsSourceFromCompiler = (
  ...
  if (!userDataType) {
    throw new Error("Could not find v196UserData type");
  }
