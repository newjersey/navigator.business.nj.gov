 ...
 * by fully expanding the `v195UserData` type from the migration source.
 *
...
/**
 * Uses the TypeScript Compiler API to resolve the `v195UserData` interface and
...
export const generateTsSourceFromCompiler = (
  ...
  if (!userDataType) {
    throw new Error("Could not find v195UserData type");
  }
