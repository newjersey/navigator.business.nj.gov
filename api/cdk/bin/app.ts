...
const isStaticSiteOnlyDeploy = process.env.STATIC_SITE_ONLY_DEPLOY === "true";
...
if (staticSiteImageTag !== undefined && staticSiteImageTag.trim().length > 0) {
