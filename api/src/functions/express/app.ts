...
const GOV2GO_REGISTRATION_BASE_URL =
  process.env.USE_WIREMOCK_FOR_GET_TAX_CALENDAR_SEARCH?.toLowerCase() === "true"
    ? "http://localhost:9000"
    : process.env.GOV2GO_REGISTRATION_BASE_URL || `http://${IS_DOCKER ? "wiremock" : "localhost"}:9000`;
