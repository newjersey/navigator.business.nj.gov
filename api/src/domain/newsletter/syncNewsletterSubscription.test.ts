...
describe("syncNewsletterSubscription", () => {
  ...
  describe("Case A: receiveNewsletter transitions false→true", () => {
  ...
  describe("Case B: receiveNewsletter=true, same email (already subscribed — no-op)", () => {
  ...
  describe("Case C: receiveNewsletter=true, email changed while subscribed", () => {
  ...
  describe("Case D: receiveNewsletter transitions true→false", () => {
  ...
  describe("Case E: receiveNewsletter=false, was already unsubscribed (no-op)", () => {
    it("returns ok:true without calling any client method", async () => {
