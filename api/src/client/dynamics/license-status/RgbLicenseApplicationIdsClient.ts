...
export const RgbLicenseApplicationIdsClient = (
  ...
  const getLicenseApplicationIdsForAllBusinessIds = async (
    ...
    const getLicenseApplicationIds = (
      ...
      logWriter.LogInfo(`Rgb License Application Ids Client - Id:${logId}`);
      ...
      return axios
        ...
        .then((response) => {
          logWriter.LogInfo(
            `Dynamics License Application Id Client - Id:${logId} - Response: ${JSON.stringify(
              response.data
            )}`
          );
