...
import {
  appTypeKeysString,
  licenseAppType,
  RgbLicenseApplicationIdsClient,
} from "@client/dynamics/license-status/RgbLicenseApplicationIdsClient";
import {
  BusinessIdAndName,
...
describe("RgbLicenseApplicationIdClient", () => {
  ...
  beforeEach(() => {
    ...
    client = RgbLicenseApplicationIdsClient(logger, ORG_URL);
  });
