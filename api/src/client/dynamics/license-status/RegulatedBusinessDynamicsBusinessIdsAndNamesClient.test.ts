...
import { BusinessIdsAndNamesClient } from "@client/dynamics/license-status/regulatedBusinessDynamicsLicenseStatusTypes";
...
describe("RegulatedBusinessDynamicsBusinessIdsClient", () => {
