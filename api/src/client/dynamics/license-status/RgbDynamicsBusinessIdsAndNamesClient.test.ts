...
import { BusinessIdsAndNamesClient } from "@client/dynamics/license-status/rgbDynamicsLicenseStatusTypes";
...
describe("RgbDynamicsBusinessIdsClient", () => {
  ...
  beforeEach(() => {
    ...
    client = RgbDynamicsBusinessIdsAndNamesClient(logger, ORG_URL);
  });
