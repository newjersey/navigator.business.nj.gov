...
export const migrate_v118_to_v119 = (v118Data: v118UserData): v119UserData => {
  const businesses: Record<string, v119Business> = {}
  businesses[v118Data.profileData.businessName] = {
    id: "1",
    dateCreatedISO: v118Data.dateCreatedISO,
    dateLastUpdatedISO: v118Data.lastUpdatedISO,
