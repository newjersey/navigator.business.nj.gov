import {generatev178Business, generatev178UserData} from "@db/migrations/v178_add_employer_access";
...
describe("migrate_v178_to_v179", () => {
  it("adds new dateDeletedISO field to business", async () => {
    ...
    expect(v179UserData.businesses[id].dateDeletedISO).toBe(undefined);
  });
});
