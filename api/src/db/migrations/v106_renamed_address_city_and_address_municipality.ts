...
export const migrate_v105_to_v106 = (v105Data: v105UserData): v106UserData => {
  const formationFormDataModified = {
    ...v105Data.formationData.formationFormData,
    domesticAddressMunicipality: v105Data.formationData.formationFormData.addressMunicipality,
    foreignAddressCity: v105Data.formationData.formationFormData.addressCity,
  };

  delete formationFormDataModified.addressCity;
  delete formationFormDataModified.addressMunicipality;

  return {
    ...v105Data,
    formationData: {
      ...v105Data.formationData,
      formationFormData: formationFormDataModified,
    },
    version: 106,
  };
};
...
interface v106FormationAddress {
  ...
  readonly domesticAddressMunicipality?: v106Municipality;
