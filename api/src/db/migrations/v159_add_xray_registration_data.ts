  ...
  return {
    ...
    businesses: Object.fromEntries(
      Object.values(v158Data.businesses)
        .map((business: v158Business) => migrate_v158Business_to_v159Business(business))
...
export const migrate_v158Business_to_v159Business = (business: v158Business): v159Business => {
  return {
    ...business,
    version: 159,
...
export interface v159Business {
  ...
  xrayRegistrationData: v159XrayData | undefined;
  version: number;
  versionWhenCreated: number;
  userId: string;
}
...
export type v159XrayData = {
  facilityDetails?: v159FacilityDetails;
  machines?: v159MachineDetails[];
  status?: v159XrayRegistrationStatus;
  expirationDate?: string;
  deactivationDate?: string;
};

export type v159FacilityDetails = {
  businessName: string;
  addressLine1: string;
  addressLine2?: string;
...
export type v159MachineDetails = {
  name?: string;
...
export type v159XrayRegistrationStatusResponse = {
  machines: v159MachineDetails[];
  status: v159XrayRegistrationStatus;
  expirationDate?: string;
  deactivationDate?: string;
...
export type v159XrayRegistrationStatus = "ACTIVE" | "EXPIRED" | "INACTIVE";
