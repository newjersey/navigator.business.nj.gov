  ...
  return {
    ...
    businesses: Object.fromEntries(
      Object.values(v155Data.businesses)
        .map((business: v155Business) => migrate_v155Business_to_v156Business(business))
...
export const migrate_v155Business_to_v156Business = (business: v155Business): v156Business => {
  return {
    ...business,
...
// ---------------- v156 types ----------------
type v156TaskProgress = "NOT_STARTED" | "IN_PROGRESS" | "COMPLETED";
...
export interface v156Business {
  ...
  taxClearanceCertificateData: v156TaxClearanceCertificateData | undefined;
...
export type v156TaxClearanceIssuingAgency = {
  name: string;
  displayName: string;
};

export type v156TaxClearanceCertificateData = {
  issuingAgency: v156TaxClearanceIssuingAgency;
  businessName: string;
  addressLine1: string;
  addressLine2: string;
  addressCity: string;
  addressState: v156StateObject;
