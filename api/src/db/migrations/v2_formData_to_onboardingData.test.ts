...
describe("migrate_v1_to_v2", () => {
  ...
  it("replaces undefined businessName with empty string", () => {
    ...
    let v1: v1UserData = { user, formData: updatedFormData, formProgress, taskProgress, version: 1 };
    ...
    v1 = { user, formData: updatedFormData1, formProgress, taskProgress, version: 1 };
    expect(migrate_v1_to_v2(v1).onboardingData.businessName).toEqual("");
  });
